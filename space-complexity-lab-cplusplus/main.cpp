...
int main()
{
    std::cout << "=== SPACE COMPLEXITY LAB ===" << std::endl
              << std::endl;
...
void explainSpaceComplexity()
{
    ...
    std::cout << "scales as the input grows larger." << std::endl
              << std::endl;
    ...
    std::cout << "- O(2^n): Exponential space - memory doubles with each input increment" << std::endl
              << std::endl;
...
void demonstrateConstantSpace()
{
    ...
    std::cout << "int sum = a + b; // sum = " << sum << std::endl
              << std::endl;
